...
class DoctorExtraInfor extends Component {
    ...
    render() {
        let { isShowHideDetaiInfor, extraInfor } = this.state
                ...
                <div className='content-down'>
                    {isShowHideDetaiInfor === false &&
                        <div className='short-infor'>
                            ...
                            <span className='detail' onClick={() => this.handleChangeShowHide(true)}>
                    ...
                    {isShowHideDetaiInfor === true &&
                        <>
                            ...
                            <div className='hide-price'>
                                <span onClick={() => this.handleChangeShowHide(false)}>
